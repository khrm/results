...
func Handler(grpcMux http.Handler, s *Server, pluginServer *plugin.LogServer) http.Handler {
	...
	mux.Handle("/apis/results.tekton.dev/v1alpha2/parents/{parent}/results/{resultID}/records", s.ListRecordsMux())
	return mux
}
