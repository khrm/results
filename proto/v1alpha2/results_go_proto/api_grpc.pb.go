...
const (
	...
	Results_GetRecordsListSummary_FullMethodName = "/tekton.results.v1alpha2.Results/GetRecordsListSummary"
...
type ResultsClient interface {
	...
	GetRecordsListSummary(ctx context.Context, in *ListRecordsSummaryRequest, opts ...grpc.CallOption) (*ListRecordsSummaryResponse, error)
...
func (c *resultsClient) GetRecordsListSummary(ctx context.Context, in *ListRecordsSummaryRequest, opts ...grpc.CallOption) (*ListRecordsSummaryResponse, error) {
	out := new(ListRecordsSummaryResponse)
	err := c.cc.Invoke(ctx, Results_GetRecordsListSummary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ResultsServer interface {
	...
	GetRecordsListSummary(context.Context, *ListRecordsSummaryRequest) (*ListRecordsSummaryResponse, error)
...
func (UnimplementedResultsServer) GetRecordsListSummary(context.Context, *ListRecordsSummaryRequest) (*ListRecordsSummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecordsListSummary not implemented")
}
...
func _Results_GetRecordsListSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRecordsSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResultsServer).GetRecordsListSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Results_GetRecordsListSummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResultsServer).GetRecordsListSummary(ctx, req.(*ListRecordsSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Results_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRecordsListSummary",
			Handler:    _Results_GetRecordsListSummary_Handler,
		},
		{
